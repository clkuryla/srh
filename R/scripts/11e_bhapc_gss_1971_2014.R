# ==============================================================================
# 11e_bhapc_gss_1971_2014.R
# BHAPC Analysis for GSS restricted to 1971-2014
# Purpose: Test if cohort effects persist when excluding post-2014 data
# ==============================================================================

cat("\n", strrep("=", 70), "\n")
cat("BHAPC GSS RESTRICTED (1971-2014)\n")
...
# Output directory
output_dir <- here("output", "bhapc_parallel", "restricted_gss_1971_2014")
...
# Variance chart
var_chart <- create_variance_chart(variance_df, survey = "gss_1971_2014")
...
cat("\n", strrep("=", 70), "\n")
cat("COMPLETE: GSS RESTRICTED (1971-2014)\n")
