# ==============================================================================
# 11_bhapc_gss_restricted.R
# BHAPC Analysis for GSS restricted to 1994-2024
# Purpose: Test if cohort effects persist when excluding pre-1994 data
# ==============================================================================

cat("\n", strrep("=", 70), "\n")
cat("BHAPC GSS RESTRICTED (1994-2024)\n")
...
# Output directory
output_dir <- here("output", "bhapc_parallel", "restricted_gss_1994")
...
cat("  Original GSS N (all years):", format(nrow(readRDS(data_path)), big.mark = ","), "\n")
...
# Variance chart
var_chart <- create_variance_chart(variance_df, survey = "gss_restricted")
...
cat("\n", strrep("=", 70), "\n")
cat("COMPLETE: GSS RESTRICTED (1994-2024)\n")
