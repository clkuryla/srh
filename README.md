...
This prevents duplication of large files and allows multiple projects to reference the same raw data.
...
project/
  ...
  code_analysis/       # scripts for modeling and intermediate analyses
  reports/        # R Markdown files for figures and tables
  outputs/        # generated figures and tables
  sandbox/        # exploratory / in-progress code
  notes/          # decision notes and documentation
...
R Markdown files that generate figures, tables, and narrative.
...
data-raw/01_wrangle_dataset1.R
data-raw/02_wrangle_dataset2.R


Run analysis scripts (if applicable):

analysis/01_models.R
analysis/02_sensitivity.R
