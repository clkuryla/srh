...
**Data**: BRFSS, MEPS, NHIS, GSS, CPS, NHANES
...
source(here::here("R/functions/srh_and_age_over_time.R")) # Functions for this analysis/exploration
...
# Use chunked version for large BRFSS dataset
...
# Regular version works for smaller datasets
